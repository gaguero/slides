...
const STRINGS = {
  en: {
    ...
    'slides.left.2.item1': 'The manual first email used by agents—refined by Kelly over time—is proven to drive quick replies.',
  ...
  es: {
    ...
    'slides.left.2.item1': 'El primer correo manual usado por los agentes—refinado por Kelly con el tiempo—está comprobado que genera respuestas rápidas.',
